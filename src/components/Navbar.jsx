            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    >
                        ...
                        <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-white transition-colors"><Linkedin size={20} /></a>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="flex flex-col p-6 gap-4">
                            ...
                            <div className="flex gap-6 mt-4 pt-4 border-t border-zinc-800">
                                ...
                                <a href="#" className="text-zinc-400 hover:text-white"><Linkedin size={20} /></a>
