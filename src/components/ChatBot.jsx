...
const ChatBot = () => {
    ...
    const [messages, setMessages] = useState([
        { type: 'bot', text: "Hi! I'm Prince's virtual assistant. Ask me anything about his projects, skills, or experience!" }
    ]);
    ...
    return (
        <div className={`fixed bottom-24 right-8 z-50 flex flex-col items-end transition-opacity duration-300 ${isVisible ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        <div className="bg-zinc-800 p-4 flex items-center justify-between border-b border-zinc-700">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-zinc-400">Online | Portfolio Assistant</p>
                                </div>
                            </div>
                            <button
